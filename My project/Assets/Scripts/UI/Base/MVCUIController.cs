...
namespace TagMeIfYouCan.UI{
	public abstract class MVCUIController : MonoBehaviour {
		...
		public virtual void HideUI() {	m_mvcUIView.HideUI(); }

		public virtual void SetParent(Transform p_newParent) { m_mvcUIModel.parentDisplay.transform.parent.SetParent(p_newParent, false); }	
	}
}